...
public class TurretServo implements ServoEx {
    ...
    public TurretServo(HardwareMap hw, String servoName, double minAngle, double maxAngle, AngleUnit angleUnit) {
    ...
    public TurretServo(HardwareMap hw, String servoName, double minDegree, double maxDegree) {
    ...
    public void setPwmRange(double minPwm, double maxPwm) {
        servo.setPwmRange(new PwmControl.PwmRange(minPwm, maxPwm));
    }
